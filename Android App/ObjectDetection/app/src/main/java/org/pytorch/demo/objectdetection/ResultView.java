...
public class ResultView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mResults == null || mResults.isEmpty()) return; // Check if there are no results
        ...
        for (Result result : mResults) {
            ...
            if (result.classIndex >= 0 && result.classIndex < PrePostProcessor.mClasses.length) {
                ...
                Log.e("ResultView", "Invalid class index: " + result.classIndex);
            }
        }
    }
